...
NS.mSlots = function() {
    ...
    this.getItemByID = function(id) {
        ...
        this.slots.forEach(function(slot) {
            slot.forEach(function(m) {
                if (m[1].id === id) {str = JSON.stringify(m);}
            });
        });
        return str;},
    ...
    this.rekey = function() {
        ...
        this.slots.forEach(function(s) {
            if (s.length === 0) {
                s.push(['mo', {id: 'MJX-' + NS.guid(), "class": 'blank', tex: ['']}, '\u25FB']);
            }
            else {
...
MathJax.Hub.Startup.signal.Post("Snippet Editor Ready");
});

MathJax.Ajax.loadComplete("[Mathslate]/snippeteditor.js");
